...
sitesGoalsChart.CustomItem = function (ctx) {
	...
	// Add the label (title).
	sitesGoalsChart.Desc += '<p><span style="color:' + itemColor + ';font-weight:bold;">' + ctx.CurrentItem.Title + ' (' +ctx.CurrentItem.Items + ')</span></p>';
...
sitesGoalsChart.CustomFooter = function () {
