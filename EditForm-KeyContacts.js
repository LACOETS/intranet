...
{ 	
	/**Getting other field values from Edit Form**/
	var category = $("select[title='KeyContact Category Required Field']").val();
	//alert("category:-" + category);
	var startDate = $("input[title='KeyContact Start Date Required Field']").val();
	var endDate = $("input[title='KeyContact End Date']").val();
	/****/
	...
	//var requestUri = pageURL + "/_api/Web/Lists/getbytitle('Key%20Contact')/items?$select=KeyContacts_x0020_EmployeeName/EMail,KeyContacts_x0020_EmployeeName/Name,KeyContacts_x0020_EmployeeName/FirstName&$expand=KeyContacts_x0020_EmployeeName/EMail&$filter=KeyContacts_x0020_EmployeeName/EMail eq '" + _PeoplePickerEmailID;
    //var restURL = "/_api/Web/Lists/getbytitle('Key%20Contact')/items?$select=KeyContacts_x0020_Category,KeyContacts_x0020_StartDate,KeyContact_x0020_End_x0020_Date,KeyContacts_x0020_EmployeeName/EMail,KeyContacts_x0020_EmployeeName/Name,KeyContacts_x0020_EmployeeName/FirstName&$expand=KeyContacts_x0020_EmployeeName/EMail&$filter=(KeyContacts_x0020_EmployeeName/EMail eq '"+_PeoplePickerEmailID+"') and (KeyContacts_x0020_Category eq '"+category+"')";
    var restURL = "/_api/Web/Lists/getbytitle('Key%20Contact')/items?$select=KeyContacts_x0020_Category,KeyContacts_x0020_StartDate,KeyContact_x0020_End_x0020_Date,KeyContacts_x0020_EmployeeName/EMail,KeyContacts_x0020_EmployeeName/Name,KeyContacts_x0020_EmployeeName/FirstName&$expand=KeyContacts_x0020_EmployeeName/EMail&$filter=KeyContacts_x0020_Category eq '"+category+"' and KeyContacts_x0020_StartDate eq '"+startDate+"' and KeyContact_x0020_End_x0020_Date eq '"+endDate+"'";

    var requestUri = pageURL + restURL;
    //alert(requestUri);
    //KeyContacts_x0020_Category  KeyContacts_x0020_StartDate KeyContact_x0020_End_x0020_Date
 $.ajax
 ({
  url: requestUri,
  type: "GET",
