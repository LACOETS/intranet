...
$(document).ready(function () {    
	...
	$('.spotlight-slider').append('<li><div class="img-box-thumb-holder"><div class="spotlight-img"><img src="'+splittedpictureURL+'" id="SpotlightImage" alt="Image1"/></div><div class="spotlight-infotxt"><h4>'+EmployeeName+'</h4><div class="spotlight"><p class="departspot">'+JobTitle + '<span class="sep-spotlight">|</span>' + Department +'</p></div><p>Description:'+Description+'</p></div></div></li>');				
	});
