...
$(document).ready(function () {    
	$().SPServices({
		...
		CAMLViewFields: "<ViewFields><FieldRef Name='Title' /><FieldRef Name='Department' /><FieldRef Name='Modified' /><FieldRef Name='Start_x0020_date' /><FieldRef Name='End_x0020_Date' /></ViewFields>",
	...
	$('.spotlight-slider').append('<li class="img-box-thumb-holder"><div class="spotlight-img"><img src="'+splittedpictureURL+'" id="SpotlightImage" alt="Image1"/></div><div class="spotlight-infotxt"><h4>'+EmployeeName+'</h4><p class="departspot">Department: '+Department+'</p><p>Title: '+JobTitle+'</p><p>Description:'+Description+'</p></div></li>');				
	});
