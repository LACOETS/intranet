      ...
      CAMLQuery: "<Query><Where><And><Geq><FieldRef Name='End_x0020_Date' /><Value IncludeTimeValue='FALSE' Type='DateTime'><Today /></Value></Geq>" +
               ...
               completefunc: function (xData, Status) {
				$(xData.responseXML).SPFilterNode("z:row").each(function() {					
					...
					$('.aniversaryslider').append('<li class="img-box-thumb-holder"><div class="box-rowcntr"><div class="box-img-thumbnail"><div class="img-box-thumb-holder"><img src="'+splittedpictureURL+'" id="AnniversaryImage" alt="Image1"/></div></div><div class="news-info-cntr"><div class="news-title-like"><h4>'+EmployeeName+'</h4></div><div class="news-activity-dtl"><p class="news-showdate">Title:'+JobTitle+'</p><p class="news-showdate">Department:'+Department+'</p></div></div></li>');
