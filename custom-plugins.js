...
/*Lacoecommon js*/
	...
	function GetDDLValue(e){$("#txtSearchPlaceHolder").val(e.innerHTML)}function OpenUpcommingEventCalendar(){var e=$(".upcoming-event-box").find(".active"),t=e.attr("rel").trim().toUpperCase(),a="";"SHOWALL-BOX"==t?(a=getselectedCategory("lst_category_ShowAll"),window.open("../pages/upcomingeventcalendar.aspx?ReqType=All&Cat="+a,"_blank")):"SOCIALEVENT-BOX"==t?(a=getselectedCategory("lst_category_Social"),window.open("../pages/upcomingeventcalendar.aspx?ReqType=Social&Cat="+a,"_blank")):"TRAINING-BOX"==t?(a=getselectedCategory("lst_category_Training"),window.open("../pages/upcomingeventcalendar.aspx?ReqType=Training&Cat="+a,"_blank")):"BOARD-BOX"==t&&(a=getselectedCategory("lst_category_Governance"),window.open("../pages/upcomingeventcalendar.aspx?ReqType=Governance&Cat="+a,"_blank"))}function getselectedCategory(e){var t=$("#"+e+" :selected").text();return"Select Category"==t?"All":t}function searchNavigation(){try{var e="";$().SPServices({webURL:_spPageContextInfo.siteAbsoluteUrl,operation:"GetListItems",async:!1,listName:"Navigation",CAMLQuery:"<Query><Where><Eq><FieldRef Name='DisplayInSearch'/><Value Type='Boolean'>1</Value></Eq></Where><OrderBy><FieldRef Name='OrderBy' Ascending='True' /></OrderBy></Query>",completefunc:function(t,a){chksearchevent=1,e=$(t.responseXML),setSearchNavigationList(e)}}),setSearchboxtext()}catch(t){console.log(t.message)}$("#searchnavigation").change(function(){setSearchboxtext(),$("#searchnavigation").find("option").remove().end(),$("#SmallSearchInputBox1").focus()}),$("#searchnavigation").click(function(){$("#SmallSearchInputBox1").val(""),$("#searchnavigation option:eq(0)").hide(),0==chksearchevent?($("#searchnavigation option:eq(0)").hide(),$("#searchnavigation").find("option").remove().end(),setSearchNavigationList(e),$("#searchnavigation option:eq(0)").hide()):chksearchevent=0}),$("#SmallSearchInputBox1").focus(function(){$("#searchnavigation option:eq(0)").show(),$(this).css("border","none");var e=searchconsttxt+$("#txtSearchPlaceHolder").val();$(this).val().trim()==e&&$(this).val("")}),$("#SmallSearchInputBox1").focusout(function(){$("#searchnavigation option:eq(0)").hide();var e=searchconsttxt+$("#txtSearchPlaceHolder").val();""==$(this).val().trim()&&$(this).val(e)}),$("#SearchLink").click(function(){cmprtxt=searchconsttxt+$("#txtSearchPlaceHolder").val(),$("#SmallSearchInputBox1").val().trim()==cmprtxt.trim()||""==$("#SmallSearchInputBox1").val().trim()||($(this).attr("href"),$(this).attr("href",lacoesearchlink+"?k="+$("#SmallSearchInputBox1").val().trim()),1==searchtarget?$(this).attr("target","_blank"):$(this).attr("target",""))})}function setSearchNavigationList(e){$("#searchnavigation").append($("<option></option>").attr("value","").attr("target","").text("")),$(e).SPFilterNode("z:row").each(function(){$("#searchnavigation").append($("<option></option>").attr("value",$(this).attr("ows_URL").split(",")[0]).attr("target",$(this).attr("ows_OpenNewWindow")).text($(this).attr("ows_Title")))})}function setSearchboxtext(){$("#SmallSearchInputBox1").val(""),1==chksearchevent?($("#SmallSearchInputBox1").val(searchconsttxt+$("#searchnavigation option:eq(1)").text().trim()),lacoesearchlink=$("#searchnavigation option:eq(1)").val(),searchtarget=$("#searchnavigation option:eq(1)").attr("target"),$("#txtSearchPlaceHolder").val($("#searchnavigation option:eq(1)").text().trim())):(lacoesearchlink=$("#searchnavigation option:selected").val(),searchtarget=$("#searchnavigation option:selected").attr("target"),$("#SmallSearchInputBox1").val("Search "+$("#searchnavigation option:selected").text().trim()),$("#txtSearchPlaceHolder").val($("#searchnavigation option:selected").text().trim()))}function GetPSTDate(){NewD=new Date;var e=NewD.getTime(),t=6e4*NewD.getTimezoneOffset(),a=e+t,n=-1.5,o=a+36e5*n,r=new Date(o);return r}function GetPSTDateParam(e){NewD=new Date(e);var t=NewD.getTime(),a=6e4*NewD.getTimezoneOffset(),n=t+a,o=-1.5,r=n+36e5*o,i=new Date(r);return i}function GetMySiteURL(){var e="",t="",a="",n=_spPageContextInfo.userLoginName;if("undefined"==typeof n)return e;t=n.split("@")[1],a=n.split("@")[0],t="_"+t.toString().replace(/\./g,"_");var o=_spPageContextInfo.siteAbsoluteUrl,r=o.toString().split("/")[2].split("."),i="";return $.each(r,function(e,t){i=0==e?t+"-my":i+"."+t}),e="https://"+i+"/personal/"+a+t+"/Blog/default.aspx"}function removejscssfile(e,t){for(var a="js"==t?"script":"css"==t?"link":"none",n="js"==t?"src":"css"==t?"href":"none",o=document.getElementsByTagName(a),r=o.length;r>=0;r--)o[r]&&null!=o[r].getAttribute(n)&&-1!=o[r].getAttribute(n).indexOf(e)&&o[r].parentNode.removeChild(o[r])}function setViewMemberLink(){var e=_spPageContextInfo.siteAbsoluteUrl+"/SitePages/ViewMembers.aspx?url="+_spPageContextInfo.webAbsoluteUrl+"/";$("#view-members-link").attr("href",e)}$(document).ready(function(){searchNavigation(),$("#incfont").click(function(){$("body").addClass("fontIncrease")}),$("#decfont").click(function(){}),$("#originalfont").click(function(){$("body").removeClass("fontIncrease")}),1==$("#hidFlag1").val&&$("body").addClass("ApplyDark"),$("#ctl00_PlaceHolderSearchArea_SmallSearchInputBox1_csr_NavButton").mouseout(function(){$(".ms-qSuggest-list").children().attr("onmouseover","GetDDLValue(this);")}),$().SPServices({webURL:"https://lacoe.sharepoint.com/",operation:"GetListItems",async:!1,listName:"Ticker Master",completefunc:function(e,t){$(e.responseXML).SPFilterNode("z:row").each(function(){$("#TickerTapeLACOE").append("<li>"+$(this).attr("ows_Title")+"</li>")})}})});var $input=$("#SmallSearchInputBox1"),$select=$("#searchnavigation"),lacoesearchlink="",selectedtxt="",searchtarget="_blank",searchconsttxt="Search ",chksearchevent=0;window.location.href.indexOf("WrkTaskIP.aspx")>-1&&removejscssfile("corev15.css","css");
