...
$(function($, undefined) {
  ...
  SP.SOD.executeFunc("sp.js", "SP.ClientContext", function() {
    SP.SOD.executeFunc("sp.runtime.js", "SP.ClientContext", function() {
	  ...
	  var queryUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('Key Contact')/items?$select=KeyContacts_x0020_Category,KeyContact_x0020_End_x0020_Date,IsPrimaryAlternate,Email,Work_x0020_Phone,Job_x0020_Title,Image_x0020_URL&$orderby=KeyContact_x0020_End_x0020_Date asc&$top=1&$filter=KeyContacts_x0020_StartDate le datetime'" + todayDate + "' and KeyContact_x0020_End_x0020_Date ge datetime'" + todayDate + "'"; // filter by current date // VJ Change - End Date >= Today
      $.ajax({
        url: queryUrl,
        method: "GET",
        headers: {
